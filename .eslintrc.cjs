module.exports = {
  ...
  rules: {
    ...
    indent: ['error', 2, {
      ...
      MemberExpression: 1,
      ignoredNodes: ['ClassBody.body > PropertyDefinition[decorators.length > 0] > Identifier', 'JSXElement', 'JSXElement > *', 'JSXAttribute', 'JSXIdentifier', 'JSXNamespacedName', 'JSXMemberExpression', 'JSXSpreadAttribute', 'JSXExpressionContainer', 'JSXOpeningElement', 'JSXClosingElement', 'JSXFragment', 'JSXOpeningFragment', 'JSXClosingFragment', 'JSXText', 'JSXEmptyExpression', 'JSXSpreadChild'],
